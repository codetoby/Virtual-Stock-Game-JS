...
function App() {
  ...
  const fetchData = async () => {
    await axios.get(`https://api.tleem.me/user/webportfolio`, {
  ...
  return (
    <div>
      ...
      <span>
        Current Cash: <br /> 
        {!isFetching && port.userData.cash} <br />
        Portfolio Value: <br />  
        { !isFetching && port.userData.portfolio.toPrecision()} <br />
        Change $: <br />  
        { !isFetching && port.userData.change.changeTotal } <br />
        Change %:  <br /> 
        { !isFetching && port.userData.change.changePercentage }
      </span>
